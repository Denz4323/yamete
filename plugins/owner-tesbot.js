...
`
    ...
    return conn.sendButton(m.chat, hiasan, sewa, await (await fetch(`https://i.ibb.co/CJPs6pH/20221203-095917.jpg`)).buffer(), [["🗳️MENU", usedPrefix + "menu"], ["🔭DONASI", usedPrefix + "donasi"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: '',
                        mediaType: 2,
